...
package components
{
	...
	public class BaseScreenNavigator extends FeathersControl
	{
		 ...
		 * @private
		 */
		public var _activeScreenID:String;
		 ...
		 * @private
		 */
		public var _activeScreen:DisplayObject;
		 ...
		 * @private
		 */
		public function showScreenInternal(id:String, transition:Function, properties:Object = null):DisplayObject
		{
		 ...
		 * @private
		 */
		public function clearScreenInternal(transition:Function = null):void
		{
			if(!this._activeScreen)
			{
				//no screen visible.
